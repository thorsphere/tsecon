...
// Import standard library packages, tseventserver, tserr and tsfio
import (
...
func (p *Mock) GetEvents(ctx context.Context, period *tseventserver.Period) ([]tseventserver.Event, error) {
...
func (p *MockErr) GetEvents(ctx context.Context, period *tseventserver.Period) ([]tseventserver.Event, error) {
